cordova.define("com.keepe.cardio.CardIO", function(require, exports, module) { /**
...
CardIO.install = function () {
  if (!window.plugins) {
    window.plugins = {};
  }

  window.plugins.cardio = new CardIO();
  return window.plugins.cardio;
};

cordova.addConstructor(CardIO.install);
